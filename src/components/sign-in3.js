        ...
        <div className="sign-in3-form-root">
          <div className="sign-in3-form">
            <h2>
              {props.heading1 ?? (
                <Fragment>
                  <h2 className="sign-in3-text10 thq-heading-2">Sign In</h2>
                </Fragment>
              )}
            </h2>
            ...
            <div className="sign-in3-container2">
              ...
              >
                <span>
                  {props.action1 ?? (
                    <Fragment>
                      <span className="sign-in3-text09 thq-body-small">
                        Email
                      </span>
                    </Fragment>
                  )}
        ...
        <div className="sign-in3-container3">
          <div className="sign-in3-divider">
            ...
            <p>
              {props.content1 ?? (
                <Fragment>
                  <p className="sign-in3-text07 thq-body-large">
                    Access your account to explore real-time data analytics and
          ...
          <button type="button" className="sign-in3-button1 thq-button-outline">
            <span>
              {props.action2 ?? (
                <Fragment>
                  <span className="sign-in3-text08 thq-body-small">
                    Password
                  </span>
                </Fragment>
              )}
...
SignIn3.defaultProps = {
  image1Src:
    'https://images.unsplash.com/photo-1512156281083-acfd62ad87c1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyMzE3ODAxOXw&ixlib=rb-4.0.3&q=80&w=1080',
  image1Alt: 'Illustration of a login screen',
  content1: undefined,
  action2: undefined,
  action1: undefined,
  heading1: undefined,
