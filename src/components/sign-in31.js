    ...
    <div className="sign-in31-container thq-section-padding">
      <div className="sign-in31-max-width thq-section-padding thq-section-max-width">
        <div className="sign-in31-form-root">
          <div className="sign-in31-form">
            <h2>
              {props.heading1 ?? (
                <Fragment>
                  <h2 className="sign-in31-text10 thq-heading-2">Sign In</h2>
                </Fragment>
              )}
            </h2>
            ...
            <div className="sign-in31-container2">
              ...
              >
                <span>
                  {props.action1 ?? (
                    <Fragment>
                      <span className="sign-in31-text09 thq-body-small">
                        Email
                      </span>
                    </Fragment>
                  )}
        ...
        <div className="sign-in31-container3">
          <div className="sign-in31-divider">
            <div className="sign-in31-divider1"></div>
            <p>
              {props.content1 ?? (
                <Fragment>
                  <p className="sign-in31-text07 thq-body-large">
                    Access your account to start using our real-time data
                    analytics and forecasting platform.
                  </p>
                </Fragment>
              )}
            </p>
            <div className="sign-in31-divider2"></div>
          </div>
          <button
            type="button"
          ...
          >
            <span>
              {props.action2 ?? (
                <Fragment>
                  <span className="sign-in31-text08 thq-body-small">
                    Password
                  </span>
                </Fragment>
              )}
...
SignIn31.defaultProps = {
  image1Src:
    'https://images.unsplash.com/photo-1488229297570-58520851e868?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyMzE3ODQ4M3w&ixlib=rb-4.0.3&q=80&w=1080',
